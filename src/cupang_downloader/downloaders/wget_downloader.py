...
class WgetDownloader(DownloaderSubprocessMixin, DownloaderBase):
    """WgetDownloader uses `wget` to download files."""

    def __init__(self, wget_bin: str | Path = None, cancel_event: Event = None, chunk_size: int = None) -> None:
        """
        Args:
